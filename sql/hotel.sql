...
CREATE TABLE `Coupon` (
  ...
  /*'target_roomNum' int(11) NOT NULL ,*/
  PRIMARY KEY (`id`)
...
INSERT INTO `Room` VALUES (2,199,20,20,1,'BigBed',null),(3,299,30,30,1,'DoubleBed',null),(4,399,10,10,1,'Family',null),(5,122,7,0,1,'BigBed',null),(6,399,10,10,2,'Family',null);
