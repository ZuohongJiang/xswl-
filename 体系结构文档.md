...
![Server](https://software-181870027.oss-cn-hangzhou.aliyuncs.com/%E9%85%92%E5%BA%97%E7%AE%A1%E7%90%86/%E4%BD%93%E7%B3%BB%E7%BB%93%E6%9E%84%E6%96%87%E6%A1%A3/%E5%90%8E%E7%AB%AF%28%E6%9C%8D%E5%8A%A1%E7%AB%AF%29.jpg)
...
| 接口                                                         | 服务调用方 | 服务提供方 |
| :----------------------------------------------------------- | :--------: | :--------: |
| AdminService<br />CouponService<br />CouponMatchStrategy<br />HotelService<br />RoomService<br />OrderService<br />AccountService |   展示层   | 业务逻辑层 |
  ...
  <table>
   ...
   <tr>
     ...
     <tr>
        ...
        <td colspan="2">生成一个POJO Hotel对象</td>
     </tr>
     <tr>
     ...
     <tr>
        <td>HotelService.updateRoomInfo</td>
        <td colspan="2">调用数据层接口更新客房信息</td>
     </tr>
	 <tr>
      <td>RoomService.editRoomInfo</td>
      <td colspan="2">调用数据层接口更新客房数据</td>
   </tr>
  </table>
...
| AdminMapper   | 持久化userType为"HotelManager"的User对象的接口，提供增删改查服务 |
| CouponMapper  | 持久化Coupon对象的接口,提供增删改查服务                      |
| OrderMapper   | 持久化Order对象的接口，提供增删改查服务                      |
| AccountMapper | 持久化userType为“client"的User对象的接口，提供增删改查服务   |
...
<table>
   ...
   <tr>
      <td>后置条件</td>
      <td>根据hotelId和roomType获得持久化对象hotelRoom的curNum字段的值</td>
   </tr>
   <tr>
